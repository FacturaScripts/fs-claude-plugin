...
export const geographicWriteTools: Tool[] = [
  {
    name: 'create_pais',
 ...
 */
export async function registerGeographicTools(tools: Map<string, Tool>): Promise<void> {
 ...
 */
export async function handleGeographicTool(
  name: string,
