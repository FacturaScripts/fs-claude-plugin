...
export const purchasingTools: Tool[] = [
    {
...
// ──────────────────────────────────────────────────
// Interfaces para operaciones de escritura de compras
// ──────────────────────────────────────────────────

interface LineaDocumentoProveedor {
  referencia?: string;
  descripcion?: string;
  cantidad?: number;
  pvpunitario?: number;
...
interface CreateDocumentoProveedorParams {
  connection: string;
  codproveedor: string;
...
interface DeleteDocumentoProveedorParams {
  connection: string;
  id: number;
}


export const purchasingWriteTools: Tool[] = [
 ...
 */
export async function registerPurchasingTools(tools: Map<string, Tool>): Promise<void> {
 ...
 */
export async function handlePurchasingTool(
  name: string,
  ...
  switch (name) {
          case 'get_presupuestoproveedores': {
            const params = input as any as PresupuestoProveedoresParams;
          ...
          case 'get_lineapresupuestoproveedores': {
            const params = input as any as LineaPresupuestoProveedoresParams;
            const result = await fsClient.get(
          ...
          case 'get_pedidoproveedores': {
            const params = input as any as PedidoProveedoresParams;
            const result = await fsClient.get(
              '/pedidoproveedores',
              {
                offset: params.offset,
          ...
          case 'get_lineapedidoproveedores': {
            const params = input as any as LineaPedidoProveedoresParams;
            const result = await fsClient.get(
          ...
          case 'get_albaranproveedores': {
            const params = input as any as AlbaranProveedoresParams;
            const result = await fsClient.get(
              '/albaranproveedores',
              {
                offset: params.offset,
          ...
          case 'get_lineaalbaranproveedores': {
            const params = input as any as LineaAlbaranProveedoresParams;
            const result = await fsClient.get(
          ...
          case 'get_facturaproveedores': {
            const params = input as any as FacturaProveedoresParams;
            const result = await fsClient.get(
              '/facturaproveedores',
              {
                offset: params.offset,
          ...
          case 'get_lineafacturaproveedores': {
            const params = input as any as LineaFacturaProveedoresParams;
            const result = await fsClient.get(
          ...
          case 'get_reciboproveedores': {
            const params = input as any as ReciboProveedoresParams;
            const result = await fsClient.get(
              '/reciboproveedores',
              {
                offset: params.offset,
          ...
          case 'get_pagoproveedores': {
            const params = input as any as PagoProveedoresParams;
            const result = await fsClient.get(
              '/pagoproveedores',
              {
                offset: params.offset,
          ...
          case 'get_cuentabancoproveedores': {
            const params = input as any as CuentaBancoProveedoresParams;
            const result = await fsClient.get(
          ...
          case 'create_factura_proveedor': {
            const params = input as any as CreateDocumentoProveedorParams;
          ...
          case 'delete_factura_proveedor': {
            const params = input as any as DeleteDocumentoProveedorParams;
          ...
          case 'get_cuentabancoproveedores': {
            const params = input as any as { connection?: string; offset?: number; limit?: number; codproveedor?: string };
            const queryParams: Record<string, unknown> = {
              offset: params.offset || 0,
              limit: params.limit || 100,
            };
            if (params.codproveedor) queryParams.codproveedor = params.codproveedor;
            const result = await fsClient.get('/cuentabancoproveedores', queryParams, params.connection);
            return { content: [{ type: 'text' as const, text: JSON.stringify(result, null, 2) }] };
          }

          case 'create_cuentabancoproveedor': {
            const params = input as any as { connection?: string; [key: string]: unknown };
          ...
          case 'update_cuentabancoproveedor': {
            const params = input as any as { connection?: string; codcuenta: string; [key: string]: unknown };
          ...
          case 'delete_cuentabancoproveedor': {
            const params = input as any as { connection?: string; codcuenta: string };
