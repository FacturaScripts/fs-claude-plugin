 ...
 */
export async function registerConfigurationTools(
  server: Server,
  tools: Map<string, Tool>
): Promise<void> {
  // Tool: get_series
  const getSeriesTool: Tool = {
    name: 'get_series',
  ...
  const getSecuenciaDocumentosTool: Tool = {
  ...
  const getFormatoDocumentosTool: Tool = {
  ...
  const getEstadoDocumentosTool: Tool = {
  ...
  const getDocTransformationsTool: Tool = {
  ...
  const getPublicationsTool: Tool = {
  ...
  const getTotalModelesTool: Tool = {
  ...
  const getIdentificadorFiscalesTool: Tool = {
  ...
  const getAgenciaTransportesTool: Tool = {
      ...
      try {
        ...
        switch (name) {
          case 'get_series': {
            ...
            if (args.codserie) params.codserie = args.codserie;
            if (args.tipodoc) params.tipodoc = args.tipodoc;
