...
export const pedidoClienteMetadata: ModelMetadata = {
    "name": "pedido_cliente",
    "table": "pedidoscli",
    ...
    "columns": [
        ...
        },
        {
            ...
            "label": "codagente",
            "maxLength": 10,
            "description": "Agente comercial asignado al pedido. Cobra comisiones por la venta.",
            "foreignKey": {
                "table": "agentes",
                "column": "codagente",
                "onDelete": "SET NULL",
        ...
        },
        {
            ...
            "label": "codalmacen",
            "maxLength": 4,
            "description": "Almacén desde el que se sirve el pedido.",
            "foreignKey": {
                "table": "almacenes",
                "column": "codalmacen",
                "onDelete": "RESTRICT",
        ...
        },
        {
            ...
            "label": "codtrans",
            "maxLength": 8,
            "description": "Agencia de transporte usada para el envío.",
            "foreignKey": {
                "table": "agenciastrans",
                "column": "codtrans",
                "onDelete": "SET NULL",
        ...
        },
        {
            ...
            "isRequired": false,
            "label": "idempresa",
            "description": "Empresa que recibe el pedido. En multi-empresa filtra los datos.",
            "widget": "number",
            "foreignKey": {
                "table": "empresas",
                "column": "idempresa",
        ...
        },
        {
            ...
            "isRequired": false,
            "label": "idestado",
            "description": "Estado actual del pedido en su flujo (borrador, aprobado, servido, etc.).",
            "widget": "number",
            "foreignKey": {
