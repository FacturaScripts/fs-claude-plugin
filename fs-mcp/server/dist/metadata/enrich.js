 ...
 */
function isTrivialDescription(desc) {
    return desc === undefined || desc === null || desc.trim() === '';
}
function enrichProperty(propName, prop, column, stats) {
 ...
 */
function enrichTool(tool, stats) {
 ...
 */
export function enrichAllTools(tools) {
    const stats = {
        toolsProcessed: 0,
        toolsEnriched: 0,
        descriptionsAdded: 0,
