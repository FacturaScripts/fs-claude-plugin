...
lastmod: 08-05-2026
url: https://facturascripts.com/publicaciones/personalizando-con-settings-276
---
...
![Ejemplo botones](https://i.imgur.com/2fMWnfJ.png)
...
## 🔧 Desactivar/ocultar el botón opciones
```
$this-&gt;tab(&#39;MyView&#39;)-&gt;setSettings(&#39;btnOptions&#39;, false);
```
