---
id: 766
permalink: licencia-de-facturascripts-492
title: Licencia de FacturaScripts
creationdate: 15-07-2018 00:00:00
lastmod: 20-09-2025
url: https://facturascripts.com/publicaciones/licencia-de-facturascripts-492
---
FacturaScripts es **software libre** con licencia LGPL. Puede leer la licencia completa en el propio [archivo de licencia](https://raw.githubusercontent.com/NeoRazorX/facturascripts/master/COPYING) incluido en el código.

## ¿Qué le permite la licencia LGPL?
...
### ⚠️ ¿Qué pasa con los plugins?
La licencia de FacturaScripts **solamente se aplica a FacturaScripts**, no a sus plugins, ni a los cursos, ni a la web, ni a los servidores, ni a los programadores ... Los plugins tienen cada uno su licencia. **Los plugins de pago no son software libre**, usted compra una licencia **de uso** para **una instalación**:
...
![licencia condiciones plugin](https://i.imgur.com/qrfd5ZV.png)

### 💰 ¿Qué puede cobrar a sus clientes?
- ✅ Puede instalar FacturaScripts a sus clientes y cobrar ese servicio de instalación.
...
Lo que si que puede es añadir su propio logotipo en la pantalla de login, instalar plugins y personalizar para los clientes, pero sin ocultar que el software sigue siendo FacturaScripts.

#### 👻 Pero seguro que puedo cambiarle el nombre, venderlo y que nadie se entere...
Eso es lo que piensa mucha gente. La realidad es que apenas pasan unas horas (un par de días como mucho) entre que alguien lo intenta y la comunidad reacciona:

- [STGestión, el nuevo caso de plagio tecnológico en Extremadura](http://www.elmundo.es/tecnologia/2017/02/15/58a43acc46163fbc558b4643.html).
- [La loca historia del plagio a un software libre de facturación, con premios y todo](https://www.meneame.net/m/ocio/loca-historia-plagio-software-libre-facturacion-premios-todo).