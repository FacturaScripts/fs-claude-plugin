---
id: 780
permalink: almacenes-128
title: Menú Almacén
creationdate: 09-01-2019 00:00:00
lastmod: 17-04-2026
url: https://facturascripts.com/publicaciones/almacenes-128
---
...
![nuevo almacen](https://i.imgur.com/YWC64SI.png)
![crear nuevo almacén](https://imgur.com/3XNXXSG.png)

Los campos de un almacén son:
* **Código:** debe introducir un código identificativo para el almacén.
* **Nombre: **debe introducir un nombre descriptivo para este almacén.
* **Teléfono:** teléfono de contacto del almacén (opcional).
* **Empresa:** (si hay más de una empresa) se debe seleccionar una empresa previamente creada a la cuál pertenece este almacén.
* **Dirección:** dirección del almacén (opcional).
* **Código Postal:** código postal del almacén (opcional)
* **Apartado:** apartado del almacén (opcional).
* **Ciudad:** ciudad del almacén (opcional).
* **Provincia:** provincia del almacén (opcional).
* **País:** país del almacén (opcional).

Para terminar haga clic en el **botón guardar** y ya tendrá su almacén creado.

### ✅ Almacén predeterminado
Puede configurar el almacén por defecto en el **menú Administrador → Panel de control**.

![almacen por defecto facturascripts](https://i.imgur.com/z4Z93iz.png)

### 👨‍💼 Almacén predeterminado por usuario
También puede configurar un almacén predeterminado para cada usuario. Haga clic en el **menú Administrador → Usuarios**. Luego clic en un usuario y en la siguiente pantalla tiene el **campo almacén**. Cambie el almacén predeterminado del usuario y pulse guardar. A partir de ese momento todas las facturas, albaranes, pedidos y presupuestos que cree ese usuario se crearán con ese almacén predeterminado, salvo que el usuario elija otro.

![almacen usuario](https://i.imgur.com/ktH4Kmm.png)