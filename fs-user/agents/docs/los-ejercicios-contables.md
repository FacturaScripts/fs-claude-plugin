---
id: 884
permalink: los-ejercicios-contables
title: Los ejercicios contables
creationdate: 02-01-2021 13:17:21
lastmod: 07-05-2025
url: https://facturascripts.com/publicaciones/los-ejercicios-contables
---
...
## 📅 Asignación automática de ejercicio
FacturaScripts asigna automáticamente el ejercicio a las facturas y asientos en función de su fecha. Puede tener varios ejercicios abiertos a la vez y seguir trabajando con normalidad. Lo que **no puede es tener dos ejercicios en las mismas fechas**.

## 🔒 Cerrar ejercicio
Cuando desee cerrar un ejercicio, simplemente vaya al **menú Contabilidad, Ejercicios**, haga clic en el ejercicio deseado, después pulse el **botón cerrar ejercicio**. Si deja marcada la casilla **copiar plan contable**, se copiará el plan contable.

![cerrar ejercicio](https://i.imgur.com/rzHUIQM.png)

Al cerrra el ejercicio se generará el asiento de cierre y el de apertura del ejercicio siguiente. **Deje que el proceso termine**. Los asientos y facturas del ejercicio cerrado quedan bloqueados, pero no ocultos.

### 🔐 Reabrir ejercicio
Si desea abrir un ejercicio ya cerrado, vaya al **menú Contabilidad, Ejercicios**, haga clic en el ejercicio deseado, después pulse el **botón abrir ejercicio**. Puede marcar si desea eliminar el ejercicio de cierre y/o el de apertura. Se generarán de nuevo al cerrar el ejercicio.
