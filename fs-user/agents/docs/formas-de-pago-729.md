...
---
Las formas de pago en FacturaScripts sirven para configurar la forma en la que se generan [los recibos de las facturas](/publicaciones/los-recibos-de-facturas), las fechas de vencimiento y la cuenta bancaria donde realizar el cobro. Puede gestionar las formas de pago desde el **menú Contabilidad**, **Formas de pago**.
...
* **Cuenta Bancaria**: Cuenta bancaria a la que va dicho cobro.
	* Tendremos primero que crearla en **Contabilidad**, **Formas de Pago**, **[Cuentas Bancarias](/publicaciones/cuentas-bancarias-28)**
...
Puede configurar la forma de pago para fraccionar el pago en varios recibos con el [plugin PlazosPago](/plugins/plazospago).
