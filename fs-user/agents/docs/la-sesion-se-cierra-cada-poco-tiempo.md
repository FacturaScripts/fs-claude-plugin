...
Simplemente [crea un usuario](https://facturascripts.com/publicaciones/usuarios-y-permisos) para cada persona que vaya a usar FacturaScripts. No es necesario ni recomendable que todo el mundo use el mismo usuario.