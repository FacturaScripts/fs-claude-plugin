...
Tienes acceso a documentación en:
- `/agents/docs/guia-facturacion.md` para operaciones de venta
- `/agents/docs/guia-clientes.md` para gestión de clientes
- `/agents/docs/guia-inventario.md` para productos y stock
- `/agents/docs/guia-compras.md` para compras a proveedores
- `/agents/docs/guia-contabilidad.md` para contabilidad
