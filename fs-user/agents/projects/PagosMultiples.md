...
También es posible asignar un agente a la agrupación de recibos de clientes de modo que podamos realizar una liquidación de cobro, de forma similar a un arqueo, donde indicamos el efectivo entregado por el agente y contibilizando las posibles diferencias. La liquidación se puede asignar a una cuenta contable de cartera de efectos. Esto es efectivo cuando los cobros son realizados por agentes remotos (que operan fuera de la localidad donde se ubica la central administrativa).